          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="text-center">
                ...
                <a href="tel:+77271234567" className="text-gray-600 hover:text-red-500 transition-colors text-lg">
                  +7 (727) 123-45-67
                </a>
                <p className="text-sm text-gray-500 mt-1">Для заказов и справок</p>
              </div>
              ...
              <div className="text-center">
                ...
                <a href="mailto:info@mangasushi.kz" className="text-gray-600 hover:text-red-500 transition-colors">
                  info@mangasushi.kz
                </a>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              <div>
                ...
                <p className="text-gray-700 mb-6">
                  Есть вопросы или предложения? Заполните форму, и мы свяжемся с вами в ближайшее время.
                </p>
              ...
              <div>
                <h2 className="text-3xl font-bold text-gray-900 mb-6">Как нас найти</h2>
                ...
                <div className="bg-gradient-to-br from-gray-100 to-gray-200 rounded-xl h-64 flex items-center justify-center mb-6">
                  <div className="text-center">
                    ...
                    <p className="text-sm text-gray-400">ул. Абая 150, Алматы</p>
                  </div>
                </div>

                <div className="space-y-4">
                  <h3 className="text-xl font-semibold text-gray-900">Быстрые способы связи</h3>
                  ...
                  <div className="flex items-center space-x-3 p-4 bg-white rounded-lg border border-gray-200">
                    ...
                    <div>
                      ...
                      <a href="https://wa.me/77271234567" className="text-gray-600 hover:text-red-500 transition-colors">
                        +7 (727) 123-45-67
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-3 p-4 bg-white rounded-lg border border-gray-200">
                    ...
                    <div>
                      ...
                      <a href="https://t.me/mangasushi" className="text-gray-600 hover:text-red-500 transition-colors">
                        @mangasushi
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="p-4 bg-red-50 rounded-lg border border-red-200">
                    <h4 className="font-semibold text-red-800 mb-2">Время доставки</h4>
                    <p className="text-red-700 text-sm">
                      Стандартная доставка: 30-45 минут<br />
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-6">
              <div className="bg-gray-50 rounded-lg p-6">
                <h3 className="font-semibold text-gray-900 mb-2">Какая минимальная сумма заказа?</h3>
                <p className="text-gray-700">Минимальная сумма заказа составляет 3000₸. При заказе от 10000₸ доставка бесплатная.</p>
              </div>

              <div className="bg-gray-50 rounded-lg p-6">
                <h3 className="font-semibold text-gray-900 mb-2">В какие районы вы доставляете?</h3>
                <p className="text-gray-700">Мы доставляем по всему Алматы в пределах города. Стоимость доставки зависит от района.</p>
              </div>

              <div className="bg-gray-50 rounded-lg p-6">
                <h3 className="font-semibold text-gray-900 mb-2">Можно ли оплатить картой?</h3>
                <p className="text-gray-700">Да, мы принимаем оплату наличными, картами Visa/MasterCard, а также через Kaspi и Halyk.</p>
              </div>

              <div className="bg-gray-50 rounded-lg p-6">
                <h3 className="font-semibold text-gray-900 mb-2">Есть ли скидки для постоянных клиентов?</h3>
                <p className="text-gray-700">У нас действует программа лояльности. Каждый 10-й заказ со скидкой 20%!</p>
              </div>
            </div>
          </div>
        </div>
