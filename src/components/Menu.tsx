...
const Menu = () => {
  ...
  const menuItems: MenuItem[] = [
    ...
    },
    {
      ...
      price: 4500,
      image: "🍣",
      description: "Угорь, огурец, кунжут",
      weight: "290г",
      pieces: 8,
    },
    {
    ...
    },
    {
      ...
      price: 15900,
      image: "🍱",
      description: "40 шт: ассорти из популярных роллов",
      popular: true,
      weight: "1500г",
      pieces: 40,
    },
    ...
    },
    {
      ...
      price: 8900,
      image: "🐟",
      description: "Лосось, тунец, морской окунь",
      weight: "200г",
      pieces: 9,
    },
    {
    ...
    },
    {
      ...
      price: 2200,
      image: "🍜",
      description: "Кремовый суп с кусочками лосося",
      weight: "350мл",
    },
    {
      id: 15,
    ...
    },
    {
      ...
      price: 2800,
      image: "🍗",
      description: "Куриное филе в соусе терияки",
      weight: "200г",
    },
    {
      id: 18,
    ...
    },
    {
      ...
      price: 4200,
      image: "🥗",
      description: "Рис, тунец, авокадо, огурец",
      weight: "350г",
    },
    {
      id: 20,
      name: "Вегетарианское поке",
      category: "poke",
      price: 2900,
      image: "🥗",
      description: "Рис, авокадо, огурец, эдамаме",
      weight: "300г",
    },
    {
      id: 21,
    ...
    },
    {
      ...
      price: 1800,
      image: "🥞",
      description: "Японские блинчики с начинкой",
      weight: "120г",
      pieces: 2,
    },
    {
      id: 23,
      name: "Зеленый чай мороженое",
      category: "desserts",
      price: 1500,
      image: "🍨",
      description: "Мороженое со вкусом зеленого чая",
      weight: "100г",
    },
  ];
  ...
  const categories = [
    { id: "all", name: "Все блюда", count: menuItems.length },
    {
      id: "rolls",
      name: "Роллы",
      count: menuItems.filter((item) => item.category === "rolls").length,
    },
    {
      id: "sets",
      name: "Сеты",
      count: menuItems.filter((item) => item.category === "sets").length,
    },
    {
      id: "sashimi",
      name: "Сашими",
      count: menuItems.filter((item) => item.category === "sashimi").length,
    },
    {
      id: "soups",
      name: "Супы",
      count: menuItems.filter((item) => item.category === "soups").length,
    },
    {
      id: "hot",
      name: "Горячее",
      count: menuItems.filter((item) => item.category === "hot").length,
    },
    {
      id: "poke",
      name: "Поке",
      count: menuItems.filter((item) => item.category === "poke").length,
    },
    {
      id: "desserts",
      name: "Десерты",
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-700">
              Выберите из более чем 20 видов роллов, сетов и других японских
              блюд
            </p>
          </div>
        </div>
