  ...
  return (
    <div className="bg-white">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-700 mb-8">
              Мы готовим настоящие японские суши с 2018 года и дарим вам вкус подлинной Японии
            </p>
          </div>
        </div>
      </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-gray-700 mb-4">
                  MANGA SUSHI родилась из любви к подлинной японской кухне. Наш основатель, Такеши Ямамото, 
                  проработал 15 лет поваром в лучших ресторанах Токио, прежде чем привезти свои секреты в Алматы.
                </p>
                <p className="text-gray-700 mb-4">
                  Мы используем только свежайшие ингредиенты: норвежский лосось доставляется свежим каждый день, 
                  рис готовится по традиционной технологии, а соусы делаются вручную по рецептам из Страны восходящего солнца.
                </p>
                <p className="text-gray-700">
                  За 6 лет работы мы обслужили более 100,000 клиентов и стали одним из самых популярных 
                  суши-ресторанов в Алматы.
                </p>
              </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-2">Такеши Ямамото</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-2">Анна Смирнова</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-2">Команда доставки</h3>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-gray-900 text-center mb-12">Как нас найти</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                <div className="w-16 h-16 bg-red-600 rounded-lg flex items-center justify-center mx-auto mb-4">
              ...
              <div className="text-center">
                ...
                <a href="tel:+77271234567" className="text-gray-600 hover:text-red-500 transition-colors">
                  +7 (727) 123-45-67
                </a>
              </div>
              <div className="text-center">
